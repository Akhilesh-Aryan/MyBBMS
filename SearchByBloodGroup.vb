...
Public Class SearchByBloodGroup
    ...
    Private Sub SearchByBloodGroup_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub TextBox11_TextChanged(sender As Object, e As EventArgs) Handles TextBox11.TextChanged
        Try
            ...
            If TextBox11.Text <> "" Then
                query = "SELECT * FROM Donors WHERE BloodGroup LIKE '%" + TextBox11.Text + "%' "
